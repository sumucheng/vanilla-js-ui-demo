...
function () {
  ...
  _createClass(Message, [{
    ...
    value: function bind() {
      ...
      setTimeout(function () {
        return _this.$msg.classList.add('active');
      }, 100);
      setTimeout(function () {
        _this.$msg.classList.remove('active');

        setTimeout(function () {
          _this.$msg.parentNode.removeChild(_this.$msg);
        }, 1000);
      }, 3000);
    }
  }]);
...
//# sourceMappingURL=/message.9967636f.js.map